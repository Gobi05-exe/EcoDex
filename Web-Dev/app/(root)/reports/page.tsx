  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        ...
        const Mondays = data.filter((item: any) => item.Day === 'Monday');
        const Tuesdays = data.filter((item: any) => item.Day === 'Tuesday');
        const Wednesdays = data.filter((item: any) => item.Day === 'Wednesday');
        const Thursdays = data.filter((item: any) => item.Day === 'Thursday');
        const Fridays = data.filter((item: any) => item.Day === 'Friday');
        const Saturdays = data.filter((item: any) => item.Day === 'Sarturday');
        const Sundays = data.filter((item: any) => item.Day === 'Sunday');
        ...
        setmondayCount(Mondays.length);
        settuesdayCount(Tuesdays.length);
        setwednesdayCount(Wednesdays.length);
        setthursdayCount(Thursdays.length);
        setfridayCount(Fridays.length);
        setsaturdayCount(Saturdays.length);
        setsundayCount(Sundays.length);
